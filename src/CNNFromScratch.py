...
'''Module is running the wights training for CNNFromScratch, which is a Pycnn implementation of "Text Understanding
    from Scratch" paper by Xiang Zhang & Yann LeCun published in arXiv in April 2016.'''
